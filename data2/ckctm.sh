...
awk '{ if ($2 <= 21 && $2 >= 14)  printf "%-10s %-2s %-5s %-10s\n", $1, $2 , $4 , $5 }' costomer7.txt
echo " "
echo "    จะหมดอายุก่อนวันที่ 30 / $x ให้แจ้งลูกค้าด่วน  "
echo "--------------------------------------------------------------------"
echo "user       d  server   facebook "

awk '{ if ($2 <= 30 && $2 >= 21)  printf "%-10s %-2s %-5s %-10s\n", $1, $2 , $4 , $5 }' costomer7.txt
echo " "
