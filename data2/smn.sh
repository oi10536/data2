...
#Menu
echo ""
echo -e "\033[01;34mList คำสั่งที่ใช้กับ vps เครื่องนี้เท่านั้น  อัพเดต 11 ก.ค. 61\033[0m"
echo " ------------------------------- "
echo -e " "
...
echo -e "* 47 | d12u12      | : ความเร็วของ vpn คือ ดาวโหลด 10 M อัพโหลด 10 M "
echo -e "* 48 | d15u15      | : ความเร็วของ vpn คือ ดาวโหลด 15 M อัพโหลด 15 M "
echo -e "* 49 | cksp        | : แสดงค่าความเร็วของ vpn ที่ตัั้งไว้ "
echo -e "* 50 | stopspeed | : ยกเลิกควบคุมความเร็ว ของ vpn "
echo -e "* 51 | showrh | : แสดง remote และ host ที่ใช้งาน "
echo -e "* 52 | bwuser3 | : แสดงแบนวิทของบัญชีที่กำลังใช้งานแบบที่ 3(เวลาเริ่มเชื่อมต่อ)  "
echo -e "* 53 | npauto | : สร้างบัญชีและรหัสอัตโนมัติ ตั้งค่าแต่จำนวนวันใช้งาน "
echo -e "* 54 | sangmander| : อัพเดตสคริป(ต้องใช้รหัสในการอัพเดต)"
echo -e ""
echo " ------------------------------- "
echo ""
echo -e "\033[01;35mพิมพ์คำสั่ง ตามเมนูข้างบนเท่านั้น  อัพเดต 11 ก.ค.61  \033[0m"
echo ""
echo " ------------------------------- "
echo ""